    ...
    <body class="bg-teal-900 text-white">
        <div id="successPopup" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 hidden">
          <div class="bg-white rounded-lg p-6 max-w-sm w-full text-center">
            ...
            <p class="text-gray-600 mt-2">Pesan kamu sudah diterima oleh tim kami, silahkan tunggu balasan pada email kamu.</p>
            <button id="closePopup" class="mt-4 bg-[#EC5A49] text-white px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-[]">
              Close
            </button>
          </div>
        </div>
        ...
        <header class="flex justify-between items-center p-6">
            ...
            <nav class="space-x-2 lg:space-x-6 ml-2 flex flex-row">
                <a
                    class="text-white hover:text-red-500 text-md lg:text-lg"
                    href="/"
                >
                    Home
                </a>
                ...
                <a
                    class="text-white hover:text-red-500 text-md lg:text-lg text-nowrap"
                    href="/about_us/"
                >
                    About Us
                </a>
            ...
            <a
                class="bg-[#EC5A49] text-white px-8 py-2 rounded-lg hidden lg:block"
                href="/donation/"
            >
                Donasi Sekarang
            </a>
        ...
        >
            <div class="flex flex-col mx-16 w-screen lg:w-auto">
                <h1
                    class="font-normal text-4xl lg:text-6xl mb-8 text-nowra text-center lg:text-left"
                >
                    Kontak Kami
                </h1>
                <div class="flex flex-row flex-wrap mx-auto">
                    <div
                        class="flex flex-col justify-center ml-2 lg:ml-0 mt-2 lg:mt-0"
                    >
                        <label for="name" class="lg:text-md text-sm font-normal"
                            >Nama Lengkap</label
                        >
                        <input
                            type="text"
                    ...
                    <div class="flex flex-col justify-center ml-2 mt-2 lg:mt-0">
                        <label
                            for="email"
                            class="lg:text-md text-sm font-normal"
                            >Email</label
                        >
                        <input
                            type="text"
                ...
                <div class="flex flex-col mt-4">
                    <label for="message" class="lg:text-md text-sm font-normal"
                        >Pesan</label
                    >
                    <textarea
                        rows="4"
                ...
                <div
                    class="flex flex-row items-center justify-center flex-wrap lg:flex-nowrap"
                >
                    <div class="flex flex-row items-center justify-center">
                        <img src="/whatsapp.svg" class="w-8 h-8" />
                        <a
                            class="text-lg lg:text-xl font-normal ml-2"
                            href="https://wa.me/6285710251303"
                            >+6285710251303</a
                        >
                    </div>
                    <div class="flex flex-row items-center justify-center">
                        ...
                        <a
                            class="text-lg lg:text-xl font-normal ml-2"
                            href="https://instagram.com/kampus_peduli_upnvj"
                            >@kampus.peduliupnvj</a
                        >
                    </div>
                </div>
                <div class="flex flex-row items-center mr-auto my-8">
                    ...
                    <a
                        class="text-md lg:text-xl font-normal ml-2 underline mr-auto"
                        href="mailto:support@kampuspeduliupnvj.com"
                        >support@kampuspeduliupnvj.com</a
                    >
                </div>
                <p
                    class="text-center font-light text-gray-200 text-md mt-8 max-w-[400px] mb-4"
                >
